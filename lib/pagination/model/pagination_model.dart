...
List<PaginationModel> sampleJsonFromJson(String str) =>
    List<PaginationModel>.from(
        json.decode(str).map((x) => PaginationModel.fromJson(x)));

String sampleJsonToJson(List<PaginationModel> data) =>
...
class PaginationModel {
  ...
  factory PaginationModel.fromJson(Map<String, dynamic> json) =>
      PaginationModel(
        ...
        links: SampleJsonLinks.fromJson(json["links"]),
        likes: json["likes"],
...
class SampleJsonLinks {
  ...
  factory SampleJsonLinks.fromJson(Map<String, dynamic> json) =>
      SampleJsonLinks(
        self: json["self"],
        html: json["html"],
